...
namespace CSITGroupAssignment {
	...
	/// <summary>
	/// Summary for JoinEvent
	/// </summary>
	public ref class JoinEvent : public System::Windows::Forms::Form
	{
		String ^ id;
		String ^ name;
		void UpdateList();
	...
	private: System::Windows::Forms::Button^  JEvent;
	...
	public:
		...
		JoinEvent(String ^ idtext, String ^ nametext)
		{
			id = idtext;
			name = nametext;
			connection->ConnectionString = "Provider = Microsoft.ACE.OLEDB.12.0; Data Source = TestEvent.accdb; Persist Security Info = False;";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->JEvent = (gcnew System::Windows::Forms::Button());
			...
			this->EName->Size = System::Drawing::Size(123, 13);
			this->EName->TabIndex = 0;
			this->EName->Text = L"Select the Event to join: ";
			// 
			// EventList
			// 
			...
			// JEvent
			// 
			this->JEvent->Location = System::Drawing::Point(400, 74);
			this->JEvent->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->JEvent->Name = L"JEvent";
			this->JEvent->Size = System::Drawing::Size(111, 28);
			this->JEvent->TabIndex = 2;
			this->JEvent->Text = L"Join Event";
			this->JEvent->UseVisualStyleBackColor = true;
			this->JEvent->Click += gcnew System::EventHandler(this, &JoinEvent::JEvent_Click);
			// 
			// MMenuBtn
			// 
			...
			this->MMenuBtn->Click += gcnew System::EventHandler(this, &JoinEvent::MainMenu_Click);
			// 
			// JoinEvent
			// 
			...
			this->Controls->Add(this->JEvent);
			this->Controls->Add(this->EventList);
			this->Controls->Add(this->EName);
			this->Name = L"JoinEvent";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Join Event";
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void JEvent_Click(System::Object^  sender, System::EventArgs^  e);
